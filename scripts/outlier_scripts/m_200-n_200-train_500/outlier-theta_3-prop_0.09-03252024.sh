#!/bin/bash
#$ -N outlier-m_200-n_200-train_500-theta_3-prop_0.09-03252024.sh
#$ -t 1-90
...
python -u outlierdetection_CC.py --name '03252024-outlier-m_200-n_200-train_500-theta_3-prop_0.09' --start_seed $startseed --end_seed $endseed --prop_outliers 0.09 --m 200 --n 200 --n_train 500 --amp $amp --exact_cs_switchpoint 0.6 --mc_max_samples 2500 --mc_batch_size 100 --power_guarantee --confidence_required --rel_mc_error 0.1 --alpha_fdr 0.1 --theta_type 3 --weight_scores