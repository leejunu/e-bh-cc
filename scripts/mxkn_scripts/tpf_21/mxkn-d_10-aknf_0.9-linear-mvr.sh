#!/bin/bash
#$ -N mxkn-derand_10-aknf_0.9-linear-mvr
#$ -t 1-60
...
python -u mxknockoffs_CC.py --name 'mxkn-derand_10-aknf_0.9-linear-mvr' --start_seed $startseed --end_seed $endseed --m 200 --n 500 --tp_freq 21 --tp_alt_sign --amp $amp  --kmethod 'mvr' --derand 10 --exact_cs_switchpoint 0.6 --mc_max_samples 2000 --mc_batch_size 100 --power_guarantee --confidence_required --rel_mc_error 0.1 --alpha_fdr 0.1 --akn_factor 0.9 --mask 'none'