...
evalue_setting = ttesting(
    Psi=Psi, df=df,
    method=args.e_method, alt_type=args.alt_type, alt=e_alt, 
...
pvalue_setting = ttesting(
    Psi=Psi, df=df, alt_type=args.alt_type, alt=e_alt
)
...
# save results 
results_path = f'results-amp_{args.amp}-alt_{args.e_alt}-sigmasq_{true_sigma_sq}-seeds_{seeds[0]}-{seeds[-1]}.csv'
